...
* **Credentials**: these are used to interact with the Google Compute Engine service. You need to provide a `credentials` JSON file, see more details [in this guide](https://cloud.google.com/docs/authentication/getting-started).
* **Region**: this is the location in the world where the resources are going to be deployed. All the available regions are [listed here](https://cloud.google.com/compute/docs/regions-zones).
...
#### How to Add a New Google Provider[¶](broken-reference)
